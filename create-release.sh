...
if [ -f ./monitoring-dashboard-release-5.7.2.tgz ]; then
  ...
  rm -rf monitoring-dashboard-release-5.7.2.tgz
fi
...
bosh create-release --force --tarball monitoring-dashboard-release-5.7.2.tgz --name monitoring-dashboard-release --version 5.7.2
